...
<body>
	...
	<h3> 예1) [R] dao -- 메소드 --> servlet -- AJAX/JACKSON --> JS -- document.querySelector --> HTML </h3>
	...
	성별			:	<input type="radio"  name="성별" value="남" > 남
					<input type="radio"  name="성별" value="여" > 여	</br>
	개인정보동의	:	<input type="checkbox" class="개인정보동의" > 동의	</br>
	사는지역		:	<select class="사는지역">
						<option>안산</option> <option>안양</option> <option>수원</option>
					</select>										</br>
	자기소개		:	<textarea class="자기소개" rows="" cols=""></textarea> </br>
	
	<button type="button" onclick="singup()"> 등록 </button>
	
	<h3> 학생 명단 </h3>
	<div class="student_box" ></div>
