...
<body>
	...
	<div class="container"> <!-- bs : 박스권 -->
		<form class="signupForm">	<!-- 폼 전송시 자식 input의 매개변수 식별 : name -->
			...
			<input onkeyup="pwdcheck()"	maxlength="20" type="password" 	name="mpw" 			class="mpw" >
			
			<div class="title"> 비밀번호 확인 </div>
			<input onkeyup="pwdconfirmcheck()" 	maxlength="20" type="password" 	name="mpwconfirm" 	class="mpwconfirm" >	
			<div class="checkconfirm" ></div>
