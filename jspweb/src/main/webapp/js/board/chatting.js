/*
	...
	JAVA serverSocket
		1. 임의의 클래스 생성
		2. 서버소켓 만들기
			클래스위에 @ServerEndpoint("ws://서버소켓경로URL")
...
if( memberInfo.mid == null ){ // memberInfo : 헤더js 존재하는 객체
	...
	클라이언트소켓 = new WebSocket('ws://localhost:8080/jspweb/chatting/'+memberInfo.mid);	// 'ws://localhost:8080/jspweb/chatting/아이디/채팅방번호'   
