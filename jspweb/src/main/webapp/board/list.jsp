	...
	<div class="container">
		...
		<div class="boardbox">
			...
			<div class="boardtopetc">
				<a href="write.jsp" > <button class="bbtn" type="button"> 글쓰기 <i class="fas fa-pencil-alt"></i> </button> </a>
				
				<div>
					<span class="searchcount"> 게시물수 : 6 </span>
			...
			<div class="boardbottom">
				...
				<div>	
					...
					<button class="bbtn" onclick="getonsearch()" type="button"> 검색 </button>
				</div>
			</div>
