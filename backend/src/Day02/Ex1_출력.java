	...
	public static void main(String[] args) {
		...
		System.out.println();
			// System : 시스템 클래스 [ 관련 메소드 제공 ]
				// out : 출력 vs in : 입력 
					// printIn() : 출력후 줄바꿈처리 [ js : console.log() ]
					// print() : 출력
					// printf() : 형식 출력
		// 2. print()
		...
		// 3. printIn()
		System.out.println("print 함수1"); // 출력후 \n
		System.out.println("print 함수1"); // 출력후 \n
		...
		// 4. [p.69] printf( "형식문자열" , 값 )
			/*
			 	형식문자열
			 		%d : 정수
			 			%자릿수d		오른쪽 자릿수 차지 [ 만일 자릿수에 데이터 없으면 공백 ]
			 			%-자릿수d		왼쪽부터 자릿수 차지 
			 			%0자릿수d		오른쪽 자릿수 차지 [ 만일 자릿수에 데이터 없으면 0 ]
			 		%f : 실수
			 			%자릿수.소수자릿수f
			 		%s : 문자열
			 */
		...
		double area = 3.14159; 
		System.out.println("반지름 넚이 : "+ area);	// 3.14159
