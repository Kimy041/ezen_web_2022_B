...
public class Ex1_참조타입 { // class s
	...
	public static void main(String[] args) { // main s
		...
		// inArray[0] =10;		// 오류 발생 : 힙영역이 없기 때문에 저장 불가능
		
		String str = null;
		// System.out.println( str.length() ); // 오류 발생 : 힙영역이 없기 때문에 저장 불가능
		...
		String kind2 = kind1;	// kind1 가지고 있던 32번지 kind2에게 대입
