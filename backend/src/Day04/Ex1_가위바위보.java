	...
	public static void main(String[] args) { // main s
		...
		while(true) { // 1. 무한루프 [ 종료조건 : ]
			...
			if( player == 3 ) {
				...
				if( pwin > cwin ) { System.out.println("player 최종 승리"); }
				else if ( pwin < cwin ) { System.out.println("com 최종 승리");}
			...
			// 7. 승리 판단 
				...
				// [ com 이기는수	   p:0 	c:1		or p:1	c:3		or p:2	c:0 ]
				// [ 비기는수		   p:0 	c:0		or p:1	c:1		or p:2	c:2 ]
