...
public class Ex1_p529 {
	public static void main(String[] args) {
		...
		ArrayList< Integer > selectNumber2 = new ArrayList<>(6); 
				// 포장 클래스 : 기존자료형-->클래스 [ *특징 API클래스중 기본자료형 사용불가 ]
