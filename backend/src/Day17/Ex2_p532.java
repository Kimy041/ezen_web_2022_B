...
public class Ex2_p532 {
	public static void main(String[] args) {
		...
		System.out.println( now ); 
			...
			// 객체명.format( 날짜객체 ) : 해당 날짜객체가 패턴 형식으로 변환 
			/*
			 	패턴
			 			y : 연도		M : 월	d : 일
			 			H : 시		m : 분	s : 초
			 */
		SimpleDateFormat sdf = new SimpleDateFormat(" yyMMdd H:m:s ");
		...
		System.out.println( "현재 원 : "+ ( cal.get( Calendar.MONTH )+1 ) ); // 1월:0 2월:1 3월:2 ~~ 12월:11
