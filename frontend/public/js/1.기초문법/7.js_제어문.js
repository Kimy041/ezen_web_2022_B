/*
	...
	제어문
		...
		1. 형태
			...
			4. if( 조건 ) { [true1]실행문; }
				else if( 조건2 ) { [true1]실행문; }
				else if( 조건3 ) { [true1]실행문; }
				else if( 조건4 ) { [true1]실행문; }
				else{ [false]실행문; }
...
// 2. if 형태2
if( 10 > 3 ) console.log('참1'); console.log('1. 10이 더크다.'); 		//[x] 2번째 console if랑 상관없이 무조건 실행
if( 10 > 20 ) console.log('참2'); console.log('2. 10이 더크다.');		//[x] 2번째 console if랑 상관없이 무조건 실행
if( 10 > 20 ) { console.log('참3'); console.log('3. 10이 더크다.'); }	//[o]
...
else if( 10 >= 50 ){ console.log('[참2] 10이 15보다 이상.'); }	// 아니면서 만약에 10>=15 이상이면
...
10 >= 50 ? console.log('[참2] 10이 15보다 이상.') :
10 >= 50 ? console.log('[참3] 10이 10보다 이상.') :
...
/*
	...
	2. prompt로 성별 입력받아 
		'M'또는'm'또는'남'또는'남자' 일경우 '남자 이군요' console 출력
		'W'또는'w'또는'여'또는'여자' 일경우 '여자 이군요' console 출력
