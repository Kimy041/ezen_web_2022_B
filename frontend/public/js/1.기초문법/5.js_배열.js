...
// 3. 배열내 특징 요소만 호출 : 배열명[인덱스]
console.log( 배열명[0] + 배열명[1] + 배열명[2] + 배열명[3] )
document.write('<ol>')
document.write('<li>'+배열명[0]+'</li>') // 변수/배열 문자열 처리X //HTML 문자열처리O
document.write('<li>'+배열명[1]+'</li>') // 변수/배열 문자열 처리X //HTML 문자열처리O
document.write('<li>'+배열명[2]+'</li>') // 변수/배열 문자열 처리X //HTML 문자열처리O
document.write('<li>'+배열명[3]+'</li>') // 변수/배열 문자열 처리X //HTML 문자열처리O
document.write('</ol>')
// 4. 배열의 길이
...
console.log( 배열명 )
// 6. 배열의 특정 요소 제거
배열명.splice( 0 , 1 ); console.log( 배열명 )	//['유재석', '강호동', '신동엽', '김현수', '전현무']
...
// 10. 배열내 요소 사이[ 서장훈과 김현수 사이 ] 요소 추가
배열명.splice( 1 , 0 , '유재석')
