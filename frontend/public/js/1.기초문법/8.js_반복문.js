	...
	반복문 : 코드 반복
 		1. for
 			1. for( 1.초기값 ; 2.조건문 ; 3.증감식 ){ 4.실행문 }
 				1. 초기값 : 반복변수 처음값
 				2. 조건문 : 조건이 true이면 실행 아니면 false 실행X
 				3. 증감식 : 반복변수 증가/감소 단위
...
for( let j = 0 ; j<10 ; j++ ){ // for s
	// i는 0부터 10미만[9] 까지 1씩증가하면서 반복 = 10회 반복
	console.log('실행문3 : ' + j )
} // for e
...
let 과일상자 = [ '사과' , '포도' , '딸기' ]	// *데이터 3개를 저장하는 배열 선언
	...
	// 1. 0부터 마지막인텍스까지의 j 반복해서 배열명[인덱스=j] 요소 호출
for( let j = 0 ; j < 과일상자.length ; j++ ){// for s
	// j는 0부터 배열의길이[3] 미만 까지 1씩 증가하면서 반복 = 0 1 2 -> 3회	
...
for( let j of 과일상자 ){ // for s
	...
	//3. in 키워드 : 기준으로 오른쪽 있는 배열/리스트내 요소 인덱스를 하나씩 왼쪽 변수에 반복 대입
for( let j in 과일상자 ){
